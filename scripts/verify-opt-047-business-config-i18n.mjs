...
includes(read('src/renderer/src/features/settings/SettingsHome.vue'), `settings.businessConfig.title`, 'src/renderer/src/features/settings/SettingsHome.vue');
includes(messages, `businessConfig: {`, messagesFile);
includes(messages, `title: '创作规则'`, messagesFile);
includes(messages, `title: 'Creation Rules'`, messagesFile);
