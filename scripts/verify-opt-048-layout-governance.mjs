...
assertIncludes('src/renderer/src/layouts/WorkbenchLayout.vue', "t('layout.backToProjects')");
assertIncludes('src/renderer/src/layouts/WorkbenchLayout.vue', 'function openProjects()');
assertIncludes('src/renderer/src/layouts/WorkbenchLayout.vue', 'function openSettings()');
assertNotIncludes('src/renderer/src/layouts/WorkbenchLayout.vue', 'class="project-top-nav"');
assertNotIncludes('src/renderer/src/layouts/WorkbenchLayout.vue', 'project-top-nav-item');
...
assertIncludes('docs/tasks/OPT-048-全局菜单和页面布局治理.md', '顶部不再重复项目模块菜单');
