...
const checks = [
  ...
  ['src/renderer/src/features/resource-library/ResourceLibraryHome.vue', 'ManualFormDialog'],
  ['src/renderer/src/features/project/ProjectHome.vue', 'openResourceLibrary'],
