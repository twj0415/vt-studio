...
export const DEFAULT_MAIN_SKILLS: DefaultSkillDefinition[] = [
  ...
  { id: '50b49d8af5d364665b463c23f6a4d8bb', md5: '1d2e3fa43c22af19e64d8be94756c2be', path: 'script_agent_decision.md', name: 'script_agent_decision', description: '', type: 'main' },
  { id: '427727727e1095c54b6840cd21382d82', md5: '8195d006c40bd55c27e0edec68e0ce6a', path: 'script_agent_execution.md', name: 'script_agent_execution', description: '', type: 'main' },
  { id: '02848fb0dd582fd926502c77ecf9679c', md5: 'e566efbd257c8a2131431928b616e7d3', path: 'script_agent_supervision.md', name: 'script_agent_supervision', description: '', type: 'main' },
...
export const DEFAULT_REFERENCE_SKILLS: DefaultSkillDefinition[] = [
  ...
  { id: '31fb5c5a1f514ec1e66b4eba9f22d4db', md5: '8b07977635fd28531694f4c3fdb8ca7b', path: 'references/pipeline.md', name: 'pipeline', description: '面向短剧改编项目的四阶段流水线说明文档，涵盖事件提取、故事大纲、改编方案、成稿编写的串行执行流程，定义了决策层、执行层、监督层的协作规范及派发、审核、修复的交互格式与质量门控标准。', type: 'references' },
  { id: '27dc2dfc901de2180227d0269217583a', md5: '62636740887841237f2103c70de5f30e', path: 'references/adaptation_format.md', name: 'adaptation_format', description: '本文档规定了改编方案输出的标准格式，包括核心改编原则、删除决策和世界观呈现方案三大模块的书写规范，明确各模块所需涵盖的维度与要素，用于指导竖屏短剧等载体的文学改编工作。', type: 'references' },
  ...
  { id: '1abd8675c0c3e62b20c0b151d2ec0fb1', md5: '6ebbfcbe8ba29b6f3d9b89a374ca41bd', path: 'references/skeleton_format.md', name: 'skeleton_format', description: '本文档定义了故事大纲文件（skeleton.md）的标准化输出格式，涵盖故事核、人物成长隐线、三幕结构、分集决策模板、全局删减记录、付费卡点设计及自查清单，用于指导编剧将章节事件列表转化为结构完整的剧集改编方案。', type: 'references' },
  { id: '0b7828d7a6ab458a4b201122f08d6c16', md5: 'd5991b9f8d77c1c30692aff10ffd3d74', path: 'references/quality_criteria.md', name: 'quality_criteria', description: '本文档为影视/短剧项目的质量审核标准手册，涵盖事件表、故事大纲、改编方案和剧本四大模块的详细审核规则，规定了格式规范、角色名称统一、时长合理性、画面可执行性及场景氛围一致性等审核要求，用于确保各阶段产出物的内容精确性与制作可行性。', type: 'references' },
